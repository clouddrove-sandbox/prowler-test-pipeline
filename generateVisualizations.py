...
savePath='/home/runner/work/prowler/prowler/output/ResultsVisualizations-'+str(datetime.now().strftime("%Y-%m-%d-%H-%M-%S"))
os.mkdir(savePath)
...
if len(sys.argv)==2:
    ...
    resultFile='/home/runner/work/prowler/prowler/output/prowler-fullorgresults-accessdeniedfiltered.csv'
...
plt.title('Failure Severity Count Graph')
...
# =================================================
pieLabels=['INFO', 'FAILED-low', 'FAILED-medium', 'FAILED-high', 'FAILED-critical', 'PASSED-low', 'PASSED-medium', 'PASSED-high', 'PASSED-critical']
...
# Format the pie chart and display
fig, ax = plt.subplots()
colors=["blue", "green", "orange", "magenta", "red", "lightgreen", "yellow", "darkmagenta","salmon"]
...
<br>
<hr>
<h2>Pass/Fail by Severity</h2>
<img src="./{resultsBySeverity}" width="900"></img>
<br>
<hr>
<h2>Failures by Service</h2>
